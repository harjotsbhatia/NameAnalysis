...
# SAM Stack 
# ----------------------------------------------------------------------
resource "aws_cloudformation_stack" "name_api_sam_stack" {
  ...
  template_url = "https://${var.sam_code_bucket}.s3-us-west-1.amazonaws.com/${aws_s3_bucket_object.sam_deploy_object.id}"
}
